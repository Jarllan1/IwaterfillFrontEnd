        ...
        child: ListView(
          ...
          children: [
            ...
            buildDrawerItem('LIST OF CUSTOMER', () {
              ...
              // Add logic for handling List of Customer action
              print('List of Customer tapped');
            }),
            buildDrawerItem('TRANSACTION HISTORY', () {
              Navigator.pop(context); // Close the drawer
              // Add logic for handling Transaction History action
              print('Transaction History tapped');
            }),
            buildDrawerItem('AVAILABLE CONTAINER', () {
              Navigator.pop(context); // Close the drawer
              // Add logic for handling Available Container action
              print('Available Container tapped');
            }),
          ],
        ),
      ),
      body: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Expanded(child: buildInfoCard('TOTAL CUSTOMER', Icons.person)),
              SizedBox(width: 20), // Add space between the cards
              Expanded(child: buildInfoCard('ONLINE ORDERS', Icons.shopping_cart)),
            ],
          ),
          SizedBox(height: 20),
          buildReportCard('TOTAL SALES'),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              Expanded(child: buildActionButton('ADD PURCHASE', Icons.add_shopping_cart)),
              SizedBox(width: 20), // Add space between the buttons
              Expanded(child: buildActionButton('REPORT', Icons.bar_chart)),
            ],
          ),
        ],
      ),
